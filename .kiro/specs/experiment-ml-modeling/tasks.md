...
- [x] 4. Checkpoint — 데이터 파이프라인 검증
  - 모든 테스트 통과 확인

- [x] 5. Behavioral Cloning 모델 구현
  - [x] 5.1 BehavioralCloningModel 클래스 구현
...
- [x] 7. BC 추론 파이프라인 구현
  ...
  - [x]* 7.2 추론 지연 property test
    - **Property 5: Inference latency constraint**
    - **Validates: Requirements 3.2**

- [x] 8. Checkpoint — BC 파이프라인 검증
  - 모든 테스트 통과 확인

- [x] 9. CARLA Gym 환경 구현
  - [x] 9.1 CARLAGymEnv 클래스 구현
  ...
  - [x]* 9.4 Gym 환경 property tests
    - **Property 6: Step return structure**
    - **Property 7: Observation shape (224×224×3)**
    - **Validates: Requirements 4.2, 4.5**

- [x] 10. Reward Function 구현
  - [x] 10.1 RewardFunction 클래스 구현
    - R_lane = -|d_lane|
...
- [x] 11. Checkpoint — 환경 및 보상 검증
  - 모든 테스트 통과 확인

- [x] 12. RL 정책 네트워크 구현
  - [x] 12.1 RLPolicyNetwork 클래스 구현
...
- [x] 13. RL 학습 파이프라인 구현
  ...
  - [x]* 13.2 RL 학습 integration tests
    - Mock 환경으로 학습 루프 테스트
    - 체크포인트 저장/로드 테스트
    - Trajectory 수집 테스트

- [x] 14. Checkpoint — 모든 모델 및 학습 검증
  - 모든 테스트 통과 확인

- [x] 15. 평가 메트릭 시스템 구현
  - [x] 15.1 ModelEvaluator 클래스 구현
  ...
  - [x]* 15.2 평가 메트릭 property tests
    - MAE 계산 정확도 테스트
    - 충돌 카운팅 정확도 테스트

- [x] 16. 교차로 통과 테스트 구현
  - [x] 16.1 IntersectionTester 클래스 구현
    - 체크포인트에서 모델 로드
